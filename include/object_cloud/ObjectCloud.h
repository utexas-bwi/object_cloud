...
public:
  ...
  std::pair<bool, Object> add_object(const ImageBoundingBox &bbox, const cv::Mat &rgb_image, const cv::Mat &depth_image,
  ...
  std::vector<Object>
  search_box(const Eigen::Vector3f &origin, const Eigen::Vector3f &scale, const Eigen::Affine3f &box_to_map);
