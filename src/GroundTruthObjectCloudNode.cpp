...
void GroundTruthObjectCloudNode::data_callback(const sensor_msgs::Image::ConstPtr &rgb_image,
...
//TODO
void GroundTruthObjectCloudNode::hand_camera_callback(const sensor_msgs::Image::ConstPtr &rgb_image) {
